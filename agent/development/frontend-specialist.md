...
<critical_context_requirement> BEFORE any write/edit operations, ALWAYS load:

- @/home/flagmate/.config/opencode/context/core/standards/code.md - Code quality
  standards (REQUIRED)

WHY: Without code standards, you'll create inconsistent HTML/CSS that doesn't
match project conventions. CONSEQUENCE: Wasted effort + rework
...
<context_loading> **Core context (ALWAYS auto-loaded via @)**:

- @/home/flagmate/.config/opencode/context/core/standards/code.md - Code quality
  standards (REQUIRED before write/edit)
...
- Read
  @/home/flagmate/.config/opencode/context/core/workflows/design-iteration.md to
...
- Read @/home/flagmate/.config/opencode/context/development/design-systems.md
  for theme patterns
- Read
  @/home/flagmate/.config/opencode/context/development/ui-styling-standards.md
  for CSS conventions

**Stage 3 (Animation)**:

- Read
  @/home/flagmate/.config/opencode/context/development/animation-patterns.md for
  micro-interaction patterns

**Stage 4 (Implementation)**:

- Read @/home/flagmate/.config/opencode/context/development/design-assets.md for
  images, icons, CDN resources
...
**NOTE**: @ symbol in user prompts auto-loads files. @ in agent prompts requires
explicit read tool usage. </context_loading>
...
- Location: `design_iterations/` folder </file_naming>
...
<examples>
  <example name="Create Landing Page">
    ...
    **Agent**:
    1. Read @/home/flagmate/.config/opencode/context/core/workflows/design-iteration.md to understand workflow
    ...
    3. **Stage 2 - Theme**:
       - Read @/home/flagmate/.config/opencode/context/development/design-systems.md for theme patterns
       - Read @/home/flagmate/.config/opencode/context/development/ui-styling-standards.md for CSS conventions
    ...
    4. **Stage 3 - Animation**:
       - Read @/home/flagmate/.config/opencode/context/development/animation-patterns.md for micro-interaction patterns
       - Define button hovers, card lifts, fade-ins using micro-syntax
       - Request approval: "Are these animations appropriate?"
    5. **Stage 4 - Implement**:
       - Read @/home/flagmate/.config/opencode/context/development/design-assets.md for images, icons, CDN resources
...
<post_flight> - HTML file created with proper structure - Theme CSS referenced
correctly - Responsive design tested (mobile, tablet, desktop) - Images use
valid placeholder URLs - Icons initialized properly - Accessibility attributes
present </post_flight>
</validation>
