...
- Code tasks → /home/flagmate/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
...
**Approval needed before proceeding. Please review and confirm.**
  ...
  <stage id="3" name="LoadContext" required="true" enforce="@critical_context_requirement">
    ...
    1. Load required context files (if not already loaded during discovery):
       - Code tasks → Read /home/flagmate/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
