...
cp -r /home/flagmate/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/home/flagmate/.config/opencode/context/` to follow your coding standards.
...
nano ~//home/flagmate/.config/opencode/context/project/project-context.md
...
A: Edit `~//home/flagmate/.config/opencode/context/project/project-context.md` - agents automatically load this file.
